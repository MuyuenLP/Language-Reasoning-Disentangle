...
if __name__ == "__main__":
    ...
    # evaluator = mmmlu("mmmlu", "/data/works_jhguo/mlrs/results/r1-distill-qwen-7b/dev_250511/ultra_mmmlu/strength_0_0")
    # evaluator.load_results()
    # evaluator.evaluate()
    
    # root_dir = "/data/works_jhguo/mlrs/results/qwen3-1.7b/dev_250502/ultra_mmmlu"
    # leaf_dirs = []
    ...
    #         continue
    #     evaluator = mmmlu("mmmlu", _dir)
    #     evaluator.load_results()
    #     evaluator.evaluate()
        
        
    # root_dir = "/data/works_jhguo/mlrs/results/qwq/dev_250429/ultra"
    root_dirs = [
        # "/data/works_jhguo/mlrs/results/qwen25-3b-instruct/dev_250507/ultra_mmmlu",
        # "/data/works_jhguo/mlrs/results/qwen25-7b-instruct/dev_250507/ultra_mmmlu",
        # "/data/works_jhguo/mlrs/results/qwen3-1.7b/dev_250505/ultra_mmmlu",
        # "/data/works_jhguo/mlrs/results/qwen3-4b/dev_250505/ultra_mmmlu",
        # "/data/works_jhguo/mlrs/results/qwen3-8b/dev_250505/ultra_mmmlu",
        # "/data/works_jhguo/mlrs/results/r1-distill-qwen-8b/dev_250429/ultra_mmmlu",
        # "/data/works_jhguo/mlrs/results/glm-z1-9b/dev_250429/ultra_mmmlu",
        # "/data/works_jhguo/mlrs/results/qwq/dev_250429/ultra_mmmlu"
        # "/data/works_jhguo/mlrs/results/r1-distill-qwen-7b/dev_250511/ultra_mmmlu",
        "/home/jhguo/Code/mlrs/results/ablation_random_subspace/r1-distill-qwen-7b/reproduction_include"
